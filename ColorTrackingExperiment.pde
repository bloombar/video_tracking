/**
 * ColorTrackingExperiment
 * Tracking of a colored object in a web cam
 * Using on OpenCV library for Processing
 * Based on code by Greg Borenstein and Jordi Tost available here: https://github.com/atduskgreg/opencv-processing-book/blob/master/code/hsv_color_tracking/HSVColorTracking/HSVColorTracking.pde 
 */
...
//  image(colorFilteredImage, src.width, 0);
  ...
  if (strt == true) {
    ...
    fill(0, 102, 153);
    textSize(32);
    text("hey bad hombre,", 30, 30);
    text("hold up a uniquely colored object", 30, 60);
    text("then click on it", 30, 90);
  }
}
